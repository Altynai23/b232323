package Practice_08_04_2021.Student;
...
public class CybertekSchool {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Student> thirdMarketGroup = new ArrayList<>();// otherwise
        ...
        System.out.println("First market group size: "+ firstMarketGroup.size());
        System.out.println("Second market group size: "+ secondMarketGroup.size());
        System.out.println("Third market group size: "+ thirdMarketGroup.size());
        ...
        System.out.println("the youngest person in first market group: "+min+
                ", and name of the youngest student is: "+name);
        // who is the youngest avenger // born 1985 Jan 20 to 1995 Aug 15
