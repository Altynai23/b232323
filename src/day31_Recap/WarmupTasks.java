...
public class WarmupTasks {
    ...
    public static void main(String[] args) {
        ...
        String str = "MMMMMMMNNNNNNNNNNBBBBBBBAAAAAAZZZZZZZZDDDDDDDDDD";
        ...
        System.out.println("----------------------------------------");
        String word = "MMMMMMMMMMMMMMMMNNNNNNNNNNNAAAA";
        ...
        String s4 = "MMMMMMMMNNNNNNNNNNNHHHHHHHHHYYYYYYYTTTRRREEEE";
    ...
    // create a method that can remove duplicates from string, return string
    public static String removeDup(String str){ // "AABBBCC"
        String result = ""; //"ABB"

       for (char ch : str.toCharArray() ) {  // {'A', 'A', 'B', 'B', 'B', 'C', 'C'}

           if ( !result.contains( ""+ch)) { // result.index(ch)<0
               // if the character is not contained is the result, then concate the character
               result += ch;
           }
