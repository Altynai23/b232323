       ...
       // int[][] nums = {{1,2,3},{4,5}}; //2
        ...
        for ( int[][] each2D : arr3D ){ // for getting each 2 dimensional arrays from the arr3D
            for ( int [] each1D : each2D){ // for getting each 1 dimensional arrays from each 2 dimensional array
                for ( int element : each1D){ // for getting each element from single dimensional array
                    System.out.println(element+" ");
                }
                System.out.println(); // to append nem line after print the elements of each 1 dimensional array
            }
        }
